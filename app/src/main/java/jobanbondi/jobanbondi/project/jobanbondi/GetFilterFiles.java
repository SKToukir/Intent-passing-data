...
/**
 * Created by anam on 12/16/16.
 */

public class GetFilterFiles extends AppCompatActivity {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                if (item.getIsImage().contains("true")){
                    ...
                    Intent intent = new Intent(GetFilterFiles.this, ShowDetails.class);
                    ...
                    Intent intent = new Intent(GetFilterFiles.this, ShowVideoComplainActivity.class);
                    intent.putExtra("url", item.getFiles());
                    intent.putExtra("complain", item.getComplain());
                    intent.putExtra("date", item.getDateTime());
                    intent.putExtra("id_",item.getId());
